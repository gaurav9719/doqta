            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    @isset(auth()->user()->profile_pic)
                        ...
                        @if(file_exists(public_path('storage/' . auth()->user()->profile_pic)))
                            <!-- Display user profile image -->
                            <img src="{{ asset('storage/' . auth()->user()->profile_pic) }}" alt="{{ auth()->user()->name }}'s Profile"></span></a>
                        @else
                            <!-- Display default image if user profile image does not exist -->
                            <img src="{{ asset('dummy_image/dummy_user.png') }}" alt="Default Image"></span></a>
                        @endif
                    @else
                    ...
                    <div class="dropdown-menu dropdown-menu-right pullDown">
                        ...
                        <a href="#" class="dropdown-item has-icon text-danger" onclick="event.preventDefault(); showLogoutConfirmation();">
                                Logout
                            </a>
                        </form>
                        </a>
