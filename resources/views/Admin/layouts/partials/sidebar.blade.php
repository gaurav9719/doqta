  ...
  <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
              <a href="index.html"> <img alt="image" src="{{ asset('App_icon/logo.png') }}" class="header-logo" /> <span class="logo-name">Collabo</span>
              </a>
          </div>
          <ul class="sidebar-menu">
              ...
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a class="nav-link" href="{{ route('admin.influencer') }}">Influencers</a></li>
                      <li><a class="nav-link" href="{{ route('admin.business') }}">Business</a></li>
                  </ul>
              </li>
              <li class="dropdown">
