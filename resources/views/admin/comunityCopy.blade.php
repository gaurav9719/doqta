...
@section('content')
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2 me-n2">
                            <button class="btn btn-lg btn-text-primary btn-icon" type="button" id="add"
                                data-bs-toggle="modal" onclick="add_community()"><i class="material-icons">add</i></button>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="addCommunity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="javascript:void(0)" onsubmit="submit_form(this)" id="add_community_form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <center>
                            <div class="col-12 col-sm-6 col-lg-3 ">
                                ...
                                <input type="file" name="cover_pic_input" id="cover_pic_input"
    ...
    <div class="modal fade" id="editCommunity" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
