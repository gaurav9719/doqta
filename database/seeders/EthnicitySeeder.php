...
class EthnicitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //     'Dutch', 'Dutchman', 'Dutchwoman', 'East Timorese', 'Ecuadorean', 'Egyptian', 'Emirian', 'Equatorial Guinean', 'Eritrean',
        ...
        //     'Mongolian', 'Moroccan', 'Mosotho', 'Motswana', 'Mozambican', 'Namibian', 'Nauruan', 'Nepalese', 'Netherlander', 'New Zealander',
        //     'Ni-Vanuatu', 'Nicaraguan', 'Nigerian', 'Nigerien', 'North Korean', 'Northern Irish', 'Norwegian', 'Omani', 'Pakistani', 'Palauan',
        ...
        //     'Sierra Leonean', 'Singaporean', 'Slovakian', 'Slovenian', 'Solomon Islander', 'Somali', 'South African', 'South Korean', 'Spanish',
        //     'Sri Lankan', 'Sudanese', 'Surinamer', 'Swazi', 'Swedish', 'Swiss', 'Syrian', 'Taiwanese', 'Tajik', 'Tanzanian', 'Thai', 'Togolese',
        //     'Tongan', 'Trinidadian or Tobagonian', 'Tunisian', 'Turkish', 'Tuvaluan', 'Ugandan', 'Ukrainian', 'Uruguayan', 'Uzbekistani',
        //     'Venezuelan', 'Vietnamese', 'Welsh', 'Yemenite', 'Zambian', 'Zimbabwean'
        // ];
        $ethnicities = [
            ['name' => 'African American', 'type' => 1],
            ['name' => 'Afro-Caribbean', 'type' => 1],
            ['name' => 'African', 'type' => 1],
            ['name' => 'Black/White', 'type' => 1],
            ['name' => 'Black/Latino/Hispanic', 'type' => 1],
            ['name' => 'Black/Asian', 'type' => 1],
            ['name' => 'Black/Native American', 'type' => 1],
            ['name' => 'Black/Pacific Islander', 'type' => 1],
            ['name' => 'Black/Other', 'type' => 1],
        ];
