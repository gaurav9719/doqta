...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('messages', function (Blueprint $table) {
            ...
            $table->foreign('match_id')->references('id')->on('partner_matches')->onDelete('cascade');
            ...
            $table->tinyInteger('is_sender_trash')->default(0)->comment('0:not,1:delete');
            $table->tinyInteger('is_reciver_trash')->default(0)->comment('0:not,1:delete');
